...
### Ejercicio 1: Efecto de desvanecimiento
Crea una imagen que al pasar el mouse cambie de opacity: 1 a opacity: 0.5 con una transicion suave.

### Ejercicio 2: Filtros tipo Instagram
Aplica 3 filtros diferentes a 3 imagenes: vintage, dramatico y frio.

### Ejercicio 3: Boton con elevacion
Crea un boton que al hacer hover se eleve (translateY) y cambie su sombra.

### Ejercicio 4: Galeria interactiva
Crea una galeria de 3 imagenes que al pasar el mouse cambien de brillo y escala.

### Ejercicio 5: Tarjeta completa con efectos
Crea una tarjeta de perfil con:
- Elevacion al hover (transform + box-shadow)
- Imagen con filtro al hover
- Boton con transicion de color y movimiento
- Todo con transiciones suaves

### Ejercicio 6: Menu con transiciones
Crea un menu de navegacion donde los links cambien de color y tengan un subrayado que aparezca con transicion.

---

## Siguiente paso

¡Felicidades! Has completado la seccion de **Estilo y Presentacion**. Ahora pasa a la **Seccion 06: Diseno Responsivo** para aprender a hacer que tus paginas se vean bien en cualquier dispositivo.
