...
### Ejercicio 1: Escala tipografica
Crea un HTML con 6 niveles de encabezados (h1 a h6) y asigna tamanos decrecientes usando una escala logica.

### Ejercicio 2: Combinacion de fuentes
Usa Google Fonts para crear una combinacion de 2 fuentes. Aplica una a titulos y otra a parrafos.

### Ejercicio 3: Tarjeta de perfil
Crea una tarjeta con:
- Nombre (Montserrat, 32px, bold)
- Cargo (Open Sans, 18px, semi-bold)
- Empresa (color accent, 16px)
- Biografia (Open Sans, 16px, light, line-height 1.8)

### Ejercicio 4: Legibilidad
Toma un parrafo de texto y experimenta con diferentes valores de line-height (1, 1.5, 2) para ver cual es mas comodo de leer.

### Ejercicio 5: Estilo de marca
Usa letter-spacing para crear un "logo" con el nombre "TEXTPRO" en mayusculas con espaciado elegante.

---

## Siguiente paso

Ahora que dominas la tipografia, pasa a **[02-fondos-bordes-sombras](../02-fondos-bordes-sombras/)** para aprender a dar estilo visual a contenedores y elementos.
